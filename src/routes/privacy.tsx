...
export const Route = createFileRoute('/privacy')({
  loader: () => {
    const page = allLegals.find((entry) => entry.slug === 'privacy')
  ...
  head: () => ({
    ...
    meta: [
      ...
      {
        name: 'description',
        content: `Privacy Policy for ${SITE_TITLE}. Learn how we collect, use, and protect your information.`,
      },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: `${SITE_URL}/privacy` },
      { property: 'og:title', content: `Privacy Policy | ${SITE_TITLE}` },
      {
