...
function About() {
  return (
    <main className="page-wrap px-4 py-12">
      <section className="border border-border bg-card shadow-sm rounded-2xl p-6 sm:p-8">
        <img
          src="/images/lagoon-about.svg"
          alt=""
          className="mb-6 h-56 w-full rounded-2xl object-cover"
        />
        <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2">About</p>
